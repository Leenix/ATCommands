...
typedef enum ternary { AT_COMMANDS_SUCCESS = 0, AT_COMMANDS_ERROR_NO_SERIAL, AT_COMMANDS_ERROR_BUFFER_FULL, AT_COMMANDS_ERROR_SYNTAX } AT_COMMANDS_ERRORS;

typedef enum { AT_COMMAND_READ, AT_COMMAND_WRITE, AT_COMMAND_TEST, AT_COMMAND_RUN } AT_COMMAND_TYPE;
